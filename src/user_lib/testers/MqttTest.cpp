...
namespace Mqtt1
{
    ...
    void onMqttConnect(bool sessionPresent) {
        ...
        //qos=2: The broker/client will deliver the message exactly once by using a four step handshake
        uint16_t packetIdPub2 = mqttClient.publish("test/lol", 2, true, "test 3"); // best
    ...
    void onMqttSubscribe(uint16_t packetId, uint8_t qos) { //mqttClient.subscribe("test/lol", 2);
